...
**Версия 2.3** включает исправление алгоритма анализа новостей, оптимизацию выявления тем и улучшение качества аналитики.
...
| **redis**   | 100MB  | 0.05| Высокопроизводительный брокер сообщений Redis 8.4 |
| **db**      | 256MB  | 0.15| PostgreSQL с оптимизированными запросами |
| **news-analyzer**| 128MB | 0.1 | ИИ анализ новостей (5 раз в день, 8+ тем) |
...
| **news-analyzer**| 128MB | 0.1 | ✅ Enhanced analysis (8+ themes) |
| **Итого**   | **996MB** | **0.8** | **Оптимизировано для сервера 1GB RAM, 1 CPU** |
