...
| **zookeeper**| 256MB | 0.2 | 128MB    | Оптимально для координации |
| **db**      | 192MB  | 0.1 | -        | PostgreSQL с оптимизациями |
| **ИТОГО**   | **1088MB** | **0.9** | - | **35% экономии ресурсов** |
...
✅ **Экономия ресурсов**: 35% по сравнению с базовой конфигурацией
...
- **PostgreSQL**: оптимизирован до 192MB RAM с дополнительными настройками
- **Zookeeper**: оптимизирован до 256MB RAM (стабильность)
- **Итого**: экономия 35% ресурсов, стабильная работа на серверах с ограниченными ресурсами
