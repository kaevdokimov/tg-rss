...
**Иконки ссылок:**
- 🔗 - заметная иконка для ссылки на полную новость
- 📰 - менее заметная иконка для ссылки на источник новостей

Заголовок отображается обычным текстом для лучшей читаемости, ссылки доступны через иконки.
...
Вся документация по проекту находится в репозитории. Основная информация включена в этот README.
