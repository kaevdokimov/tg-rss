...
Подробности в [политике безопасности](.github/SECURITY.md).
...
Подробные правила: [`docs/commit-convention.md`](docs/commit-convention.md)
...
- **Развертывание** - [`DEPLOYMENT.md`](DEPLOYMENT.md) - полное руководство по деплою
- **Тестирование** - [`TESTING.md`](TESTING.md) - руководство по тестированию
- **Решение проблем** - [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) - troubleshooting

### Специализированная документация
- **Конвенция коммитов** - [`docs/commit-convention.md`](docs/commit-convention.md)
- **Настройка безопасности** - [`docs/security-setup.md`](docs/security-setup.md)
- **Мониторинг** - [`docs/monitoring-setup.md`](docs/monitoring-setup.md)

### Аналитический модуль
- **Документация модуля** - [`news-analyzer-python/README.md`](news-analyzer-python/README.md)
...
1. Ознакомьтесь с [`docs/commit-convention.md`](docs/commit-convention.md) - соглашение о сообщениях коммитов
2. Fork репозитория
