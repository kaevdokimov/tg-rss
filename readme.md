...
Telegram-бот для чтения RSS-лент с использованием Redis в качестве брокера сообщений. Бот предоставляет удобный интерфейс для подписки на новостные источники и получения автоматических уведомлений.
...
- 🚀 **Высокая производительность** - асинхронная обработка с использованием Redis
...
- Оптимизированным параметрам Redis и PostgreSQL
...
- memory_optimization: 80MB limit # Минимум памяти для высокой производительности
```
