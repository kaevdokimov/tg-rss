...
- **Запуск**: 2 раза в день (9:00, 21:00)
...
|-------------|--------|-----|-------------|
| **bot**     | 400MB  | 0.4 | Основной бот с оптимизациями производительности |
| **redis**   | 80MB   | 0.05| Высокопроизводительный брокер сообщений |
| **db**      | 200MB  | 0.12| PostgreSQL с оптимизированными запросами |
| **news-analyzer**| 128MB | 0.1 | ИИ анализ новостей (2 раза в день) |
| **ИТОГО**   | **808MB** | **0.67** | **Оптимизировано для сервера 900MB RAM, 1 CPU** |
