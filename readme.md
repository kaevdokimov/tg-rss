...
| **zookeeper**| 128MB | 0.1 | 64MB     | Минимум для координации |
| **db**      | 192MB  | 0.1 | -        | PostgreSQL с оптимизациями |
| **ИТОГО**   | **960MB** | **0.8** | - | **45% экономии ресурсов** |
...
✅ **Экономия ресурсов**: 45% по сравнению с базовой конфигурацией
...
- **Zookeeper**: уменьшен до 128MB RAM
- **Итого**: экономия 45% ресурсов, стабильная работа на 1GB RAM серверах
